...
def main(args, planner):
    ...
    df = pd.read_csv(args.pred_fpath)
    target_lst = df['SMILES'].to_list()
    for i, target_mol in enumerate(target_lst):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred_fpath', type=str, default='', help='pred data fpath')
